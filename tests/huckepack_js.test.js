...
const huckepack = require(path.join(__dirname, "..", "src", "researchcall", "web", "static", "huckepack.js"));

test("phone numbers do not survive into a receipt", () => {
  const masked = huckepack.maskPhones("Rufen Sie 030 1234567 an oder +49 170 1234567.");
  ...
  const text = huckepack.receiptText(
    {
      ...
      transcript: "Wirt: Ihre Nummer war 030 1234567?"
    },
    "de"
  );
